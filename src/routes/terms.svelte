  ...
  <ol class="toc ol-alpha mb-4 list-inside space-y-4">
    <li class="my-small">
      ...
      <p class="mb-4 mt-x-small">
        ...
        party service as set forth on the Website (<strong
    ...
    <li>
      ...
      <p class="mb-4">
        ...
        <strong
          >Third party claims addressed to us which result from your
    ...
    <li>
      ...
      <p class="mb-4">
        ...
        immaterial damage these Customer Data might cause. <strong
          >Third party claims addressed to us which result from violations due
    ...
    <li>
      ...
      <ol class="ol-decimal mb-4 list-inside space-y-4">
        <li>
          ...
          Street, Suite 200, San Francisco. CA 94102, United States ("<strong
            >Gitpod, Inc.</strong
          >"); or
        </li>
        <li>
      ...
      <p class="mb-4">
        ...
        transfer of this Agreement becoming effective ("<strong
