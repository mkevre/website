...
<div class="buttons space-y-4" data-analytics={`{"context":"signup"}`}>
  <LinkButton
    ...
    variant="unstyled"
    size="large"
    class="flex items-center bg-[#5e48ba] text-white hover:text-white hover:opacity-90 focus:bg-black-hover focus:text-white active:bg-black-hover active:text-white">
  ...
  <LinkButton
    ...
    variant="unstyled"
    size="large"
    class="flex items-center bg-black text-white hover:bg-black-hover hover:text-white focus:bg-black-hover focus:text-white active:bg-black-hover active:text-white">
  ...
  <LinkButton
    ...
    variant="unstyled"
    href="https://gitpod.io/new"
    class="flex items-center bg-[#265583] text-white hover:text-white hover:opacity-90 focus:bg-black-hover focus:text-white active:bg-black-hover active:text-white">
